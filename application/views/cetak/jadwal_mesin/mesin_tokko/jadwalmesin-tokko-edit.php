...
<section class="content-header">
    ...
    <?php foreach($jm as $s => $row) {?>
      <form action="<?=site_url('cetak/Jadwalmesin/edit_jadwal_tokko')?>" method="post"> 
          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <input type="date" class="form-control" name="tanggal_pelaksanaan_tokko" id="tgl_tokko<?= $row->id_order.$row->id_order; ?>" value="<?= $row->tanggal_pelaksanaan; ?>" placeholder="Tanggal Pelaksanaan Cover" >
              </div>
              <div class="col-md-6">
            ...
            <div class="row">
              <div class="col-md-6">
                <label>Target</label>
                <input type="number" class="form-control" name="target_tokko" value="<?= $row->target; ?>" placeholder="Jumlah Target" >
              </div>
              <div class="col-md-6">
                <label>Kru</label>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <label>Set</label>
                <input type="number" class="form-control" name="set_tokko" value="<?= $row->set?>" placeholder="Jumlah set cover" >
              </div>
            </div><br>
            <div class="row">
              <div class="col-md-6">
