...
<div class="card" style="background: #A9A9A9">
            ...
            <input type="text" name="id_mesin_72"  value="<?php echo $khu->id_mesin_72; ?>" hidden>
            <input type="text" name="id_order"  value="<?php echo $row->id_order; ?>" hidden>
              ...
              <div class="row">
                <div class="col">
                  <textarea class="form-control" name="keterangan_spk" value="<?= $row->keterangan_spk; ?>" placeholder="Keterangan" style="min-height: 250px;"><?= $khu->keterangan_spk; ?></textarea>
                </div>
              </div><br>
              <div class="row">
                <div class="col" align="right">
                  <button type="submit" name="editspk72" class="btn btn-success">Simpan</button>
                </div>
              </div>
            </form>
            </div>
