        ...
        <div class="card-body">
          <table id="table1" class="table table-bordered table-hover" style="font-size: 12px;">
            ...
            <tr>
              ...
              <td><?= $row->druk; ?></td>
              <td align="center">
                <a href="<?=site_url('cetak/Jadwalmesin/lihat_74a/'.$row->id_mesin_74a."-".$row->id_order)?>">
                ...
                <?php if($cek_id_mesin[$nilai] != null){?>
                  <a href="<?=site_url('cetak/Jadwalmesin/print_74a/'.$row->id_mesin_74a."-".$row->id_order)?>">
              ...
              <?php if($cek_id_mesin[$nilai] == null){?>
                ...
                <?php }else{?>
                  <a href="<?=site_url('cetak/Jadwalmesin/edit_spk_74a/'.$row->id_mesin_74a."-".$row->id_order)?>" class="btn btn-success">
