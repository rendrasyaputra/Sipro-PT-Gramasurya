...
<section class="content">
  ...
  <div class="card">
    ...
    <?php foreach($jm as $s => $row) {?> 
      <h4 class="card-title coba">SPK ORDER [<label><?= $row->nomor_so; ?></label>]</h4>

      <div class="card-tools">
        <img style="width:150px;margin: 4px;" src="<?=base_url()?>/assets/dist/img/logo gramasurys.png">
        <button type="button" class="btn btn-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse">
          <i class="fa fa-minus" hidden></i></button>
      </div>
    </div>
    <div class="card-body">
      <div class="card-body">
        ...
        <div class="row">
          <div class="col">
            <textarea class="form-control" name="keterangan_spk"  placeholder="Keterangan" style="min-height: 110px;" disabled>
            <?php if($khusus != null){foreach($khusus as $s => $khu) {?> 
            <?= $khu->keterangan_spk; ?>
            <?php }} ?>
            </textarea>
