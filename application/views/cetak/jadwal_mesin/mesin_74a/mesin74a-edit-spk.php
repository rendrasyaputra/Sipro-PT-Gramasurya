          ...
          <div class="col-sm-6">
            <ol class="breadcrumb">
              <li class="breadcrumb-item">
                <a href="<?=site_url()?>cetak/Jadwalmesin/jadwal_74a" class="btn btn-warning btn-lg">
...
<div class="card" style="background: #A9A9A9">
            ...
            <input type="text" name="id_mesin_74a"  value="<?php echo $khu->id_mesin_74a; ?>" hidden>
            <input type="text" name="id_order"  value="<?php echo $row->id_order; ?>" hidden>
              ...
              <div class="row">
                <div class="col" align="right">
                  <button type="submit" name="editspk74a" class="btn btn-success">Simpan</button>
                </div>
              </div>
            </form>
            </div>
