        ...
        <div class="card-body">
          <table id="table1" class="table table-bordered table-hover" style="font-size: 12px;">
            ...
            <?php foreach($jm as $s => $row) {
              $banding_id[$nilai] = $row->id_mesin_102a;
            ...
            <tr>
              ...
              <td><?= $row->druk; ?></td>
              <td align="center">
                <a href="<?=site_url('cetak/Jadwalmesin/lihat_102a/'.$row->id_mesin_102a."-".$row->id_order)?>">
                ...
                <?php if($cek_id_mesin[$nilai] != null){?>
                  <a href="<?=site_url('cetak/Jadwalmesin/print_102a/'.$row->id_mesin_102a."-".$row->id_order)?>">
              ...
              <?php if($cek_id_mesin[$nilai] == null){?>
                ...
                <?php }else{?>
                  <a href="<?=site_url('cetak/Jadwalmesin/edit_spk_102a/'.$row->id_mesin_102a."-".$row->id_order)?>" class="btn btn-success">
