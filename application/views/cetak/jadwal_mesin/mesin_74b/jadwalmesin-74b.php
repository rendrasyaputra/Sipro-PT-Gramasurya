    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title coba">Jadwal Mesin 74b</h3>
        ...
        <div class="card-body">
          <table id="table1" class="table table-bordered table-hover" style="font-size: 12px;">
            ...
            <?php foreach($jm as $s => $row) {
              $banding_id[$nilai] = $row->id_mesin_74b;
            ...
            <tr>
              ...
              <td><?= $row->druk; ?></td>
              <td align="center">
                <a href="<?=site_url('cetak/Jadwalmesin/lihat_74b/'.$row->id_mesin_74b."-".$row->id_order)?>">
                ...
                <a href="<?=site_url('cetak/Jadwalmesin/print_74b/'.$row->id_mesin_74b."-".$row->id_order)?>">
