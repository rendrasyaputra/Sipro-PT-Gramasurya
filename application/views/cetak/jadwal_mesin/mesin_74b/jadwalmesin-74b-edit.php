...
<section class="content-header">
    ...
    <?php foreach($jm as $s => $row) {?>
      <form action="<?=site_url('cetak/Jadwalmesin/edit_jadwal_74b')?>" method="post"> 
      <input type="text" name="id_order"  value="<?php echo $row->id_order; ?>" hidden>
      <input type="text" name="id_mesin_74b"  value="<?php echo $row->id_mesin_74b; ?>" hidden>
      <!-- Default box -->
      <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <input type="date" class="form-control" name="tanggal_pelaksanaan_74b" id="tgl_74b<?= $row->id_order.$row->id_order; ?>" value="<?= $row->tanggal_pelaksanaan; ?>" placeholder="Tanggal Pelaksanaan Cover" >
              </div>
              <div class="col-md-6">
            ...
            <div class="row">
              <div class="col-md-6">
                <label>Target</label>
                <input type="number" class="form-control" name="target_74b" value="<?= $row->target; ?>" placeholder="Jumlah Target" >
              </div>
              <div class="col-md-6">
                <label>Kru</label>
                <input type="text" name="kru_operator_74b" value="<?= $row->kru_operator_74b; ?>" placeholder="Nama Kru" class="form-control">
              </div>
            </div><br>
            <div class="row">
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                <label>Set</label>
                <input type="number" class="form-control" name="set_74b" value="<?= $row->set?>" placeholder="Jumlah set cover" >
              </div>
            </div><br>
            <div class="row">
              <div class="col-md-6">
