    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title coba">Jadwal Mesin 102b</h3>
        ...
        <div class="card-body">
          <table id="emple2xa" class="table table-bordered table-hover" style="font-size: 12px;">
            ...
            <?php foreach($jm as $s => $row) {
              $banding_id[$nilai] = $row->id_mesin_102b;
            ...
            <tr>
              ...
              <?php if($cek_id_mesin[$nilai] == null){?>
                ...
                <?php }else{?>
                  <a href="<?=site_url('cetak/Jadwalmesin/edit_spk_102b/'.$row->id_mesin_102b."-".$row->id_order)?>" class="btn btn-success">
