          ...
          <div class="col-sm-6">
            <ol class="breadcrumb">
              <li class="breadcrumb-item">
                <a href="<?=site_url()?>cetak/Jadwalmesin/jadwal_102b" class="btn btn-warning btn-lg">
...
<div class="card" style="background: #A9A9A9">
            ...
            <input type="text" name="id_mesin_102b"  value="<?php echo $khu->id_mesin_102b; ?>" hidden>
            <input type="text" name="id_order"  value="<?php echo $row->id_order; ?>" hidden>
              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  ...
                  <input type="text" name="muka2_fc_fc-bw_bw-bw" value="" hidden>
                  <input class="form-check-input" type="checkbox" name="muka2_fc_fc-bw_bw-bw" value="2 Muka : FC / FC-BW / BW-BW" <?php echo $khu->muka2_fc_fc == "2 Muka : FC / FC-BW / BW-BW"   ?  "checked" : "" ?>>
              ...
              <div class="row">
                <div class="col" align="right">
                  <button type="submit" name="editspk102b" class="btn btn-success">Simpan</button>
                </div>
              </div>
            </form>
            </div>
