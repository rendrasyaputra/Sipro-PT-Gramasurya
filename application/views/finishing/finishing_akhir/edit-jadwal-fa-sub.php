      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-4">
            ...
            <input type="date" class="form-control" name="tanggal_pelaksanaan_sub" placeholder="Tanggal Pelaksanaan" value="<?= $row->tanggal_pelaksanaan_sub; ?>">
          </div>
          <div class="col-md-4">
            Keterangan<br>
        ...
        <div class="row">
          ...
          <div class="col-md-2">
            <input type="date" class="form-control" name="tanggal_kembali_sub" placeholder="Masukan Tanggal kembali sub" value="<?= $row->tanggal_kembali_sub; ?>">
          </div>
          <div class="col-md-1">
            <input type="number" class="form-control" name="hasil" placeholder="Hasil" value="<?= $row->hasil; ?>">
          </div>
          <div class="col-md-1">
            <input type="number" class="form-control" name="rejek" placeholder="Rejek" value="<?= $row->rejek; ?>">
          </div>
          <div class="col-md-2">
            <input type="text" class="form-control" name="operator" placeholder="Nama Operator" value="<?= $row->operator; ?>">
          </div>
          <div class="col-md-2">
            <input type="text" class="form-control" name="kru" placeholder="Kru" value="<?= $row->kru; ?>">
          </div>
          <div class="col-md-3">
