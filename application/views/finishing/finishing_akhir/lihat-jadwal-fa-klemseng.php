...
<section class="content">
  <div class="card">
    ...
    <input disabled type="text"  name="id_klemseng"  value="<?= $row->id_klemseng; ?>" hidden>
      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="card-body">
                ...
                <input disabled type="text" name="status_klemseng" value="" hidden>
                <input disabled class="form-check-input" type="checkbox" name="status_klemseng" value="klemseng" id="flexCheckDefault" <?php echo $row->status_klemseng == "klemseng" ?  "checked" : "" ?>>
        ...
        <div class="row">
          <div class="col-md-4">
            ...
            <input disabled type="date" class="form-control" name="tanggal_pelaksanaan_klemseng" placeholder="Tanggal Pelaksanaan" value="<?= $row->tanggal_pelaksanaan_klemseng; ?>">
          </div>
          <div class="col-md-4">
            Keterangan<br>
            <textarea disabled name="keterangan_jadwal_klemseng" class="form-control" placeholder="catatan" style="height: 150px;"><?= $row->keterangan_jadwal_klemseng; ?></textarea>
          </div>
          <div class="col-md-4">  
            Hasil Gabung<br>
