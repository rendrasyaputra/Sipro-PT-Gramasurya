      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="card-body">
                ...
                <input class="form-check-input" type="checkbox" name="status_binding" value="binding" id="flexCheckDefault" <?php echo $row->status_binding == "binding" ?  "checked" : "" ?>>
        ...
        <div class="row">
          <div class="col-md-4">
            ...
            <input type="date" class="form-control" name="tanggal_pelaksanaan_binding" placeholder="Tanggal Pelaksanaan" value="<?= $row->tanggal_pelaksanaan_binding; ?>">
          </div>
          <div class="col-md-4">
            Keterangan<br>
        ...
        <div class="row">
          ...
          <br><br><div class="col" align="left">            
            <div class="col-md-2">                        
