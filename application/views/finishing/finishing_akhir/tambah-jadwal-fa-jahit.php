...
<section class="content">
  <div class="card">
    ...
    <?php $jadwal_max+=1; ?>
    <input type="text"  name="id_jadwal_jahit"  value="<?= $jadwal_max; ?>" hidden>
    <input type="text"  name="id_order"  value="<?= $row->id_order; ?>" hidden>
    <input type="text"  name="id_jahit"  value="<?= $row->id_jahit; ?>" hidden>
      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="card-body">
                ...
                <input type="text" name="status_jahit" value="" hidden>
                <input class="form-check-input" type="checkbox" name="status_jahit" value="jahit" id="flexCheckDefault" <?php echo $row->status_jahit == "jahit" ?  "checked" : "" ?> disabled>
        ...
        <div class="row">
          <div class="col-md-4">
            ...
            <input type="date" class="form-control" name="tanggal_pelaksanaan_jahit" placeholder="Tanggal Pelaksanaan" required>
          </div>
          <div class="col-md-4">
            Keterangan<br>
            <textarea name="keterangan_jadwal_jahit" class="form-control" placeholder="catatan" style="height: 150px;"><?= $row->keterangan_jadwal_jahit; ?></textarea>
          </div>
          <div class="col-md-4">  
            Hasil Susun<br>
