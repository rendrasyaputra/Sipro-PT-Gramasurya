...
<section class="content">
  <div class="card">
    ...
    <form action="<?=site_url('finishing/FinishingAkhir/proses_jahit')?>" method="post">      
    <input disabled type="text"  name="id_order"  value="<?= $row->id_order; ?>" hidden>
    <input disabled type="text"  name="id_jahit"  value="<?= $row->id_jahit; ?>" hidden>
      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="card-body">
                ...
                <input disabled type="text" name="status_jahit" value="" hidden>
                <input disabled class="form-check-input" type="checkbox" name="status_jahit" value="jahit" id="flexCheckDefault" <?php echo $row->status_jahit == "jahit" ?  "checked" : "" ?>>
        ...
        <div class="row">
          <div class="col-md-4">
            ...
            <input disabled type="date" class="form-control" name="tanggal_pelaksanaan_jahit" placeholder="Tanggal Pelaksanaan" value="<?= $row->tanggal_pelaksanaan_jahit; ?>">
          </div>
          <div class="col-md-4">
            Keterangan<br>
            <textarea disabled name="keterangan_jadwal_jahit" class="form-control" placeholder="catatan" style="height: 150px;"><?= $row->keterangan_jadwal_jahit; ?></textarea>
          </div>
          <div class="col-md-4">  
            Hasil Susun<br>
        ...
        <div class="row">
          ...
          <a href="<?=site_url()?>finishing/FinishingAkhir/jadwal_fa_jahit" class="btn btn-default">Kembali</a>           
          </div>
        </div>
