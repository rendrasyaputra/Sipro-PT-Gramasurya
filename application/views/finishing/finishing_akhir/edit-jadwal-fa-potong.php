      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="card-body">
                ...
                <input class="form-check-input" type="checkbox" name="status_fa_potong" value="fa potong" id="flexCheckDefault" <?php echo $row->status_fa_potong == "fa potong" ?  "checked" : "" ?>>
        ...
        <div class="row">
          <div class="col-md-4">
            ...
            <input type="date" class="form-control" name="tanggal_pelaksanaan_fa_potong" placeholder="Tanggal Pelaksanaan" value="<?= $row->tanggal_pelaksanaan_fa_potong; ?>">
          </div>
          <div class="col-md-4">
            Keterangan<br>
