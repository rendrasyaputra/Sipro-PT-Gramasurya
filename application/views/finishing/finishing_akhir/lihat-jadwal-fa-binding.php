...
<section class="content">
  <div class="card">
    ...
    <form action="<?=site_url('finishing/FinishingAkhir/proses_binding')?>" method="post">      
    <input disabled type="text"  name="id_order"  value="<?= $row->id_order; ?>" hidden>
    <input disabled type="text"  name="id_binding"  value="<?= $row->id_binding; ?>" hidden>
      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="card-body">
                ...
                <input disabled type="text" name="status_binding" value="" hidden>
                <input disabled class="form-check-input disabled" type="checkbox" name="status_binding" value="binding" id="flexCheckDefault" <?php echo $row->status_binding == "binding" ?  "checked" : "" ?>>
        ...
        <div class="row">
          <div class="col-md-4">
            ...
            <input disabled type="date" class="form-control" name="tanggal_pelaksanaan_binding" placeholder="Tanggal Pelaksanaan" value="<?= $row->tanggal_pelaksanaan_binding; ?>">
          </div>
          <div class="col-md-4">
            Keterangan<br>
            <textarea disabled name="keterangan_jadwal_binding" class="form-control" placeholder="catatan" style="height: 150px;"><?= $row->keterangan_jadwal_binding; ?></textarea>
          </div>
          <div class="col-md-4">  
            Hasil Susun<br>
