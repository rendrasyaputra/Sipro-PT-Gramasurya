        ...
        <div class="card-body">
          ...
          <table id="table1" class="table table-bordered table-striped" style="font-size: 12px">
            ...
            <?php foreach($fa as $s => $row) {?>  
              <tr align="center">
                <td><?= date('d-m-Y', strtotime($row->tanggal_pelaksanaan_spiral)); ?></td>                
                <td><?= $row->nomor_so; ?></td>
                ...
                <td <?php echo $row->status_spiral == "spiral" ?  "style='color: red'" : "" ?>><?php echo $row->status_spiral == "spiral" ?  "finishing akhir" : $row->so_status?></td>                
                <td align="center">  
