...
<section class="content">
  <div class="card">
    ...
    <form action="<?=site_url('finishing/FinishingAkhir/proses_klemseng')?>" method="post">  
     ...
     <?php $jadwal_max+=1; ?>
    <input type="text"  name="id_jadwal_klemseng"  value="<?= $jadwal_max; ?>" hidden>    
      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="card-body">
                ...
                <input class="form-check-input" type="checkbox" name="status_klemseng" value="klemseng" id="flexCheckDefault" <?php echo $row->status_klemseng == "klemseng" ?  "checked" : "" ?> disabled>
        ...
        <div class="row">
          <div class="col-md-4">
            ...
            <input type="date" class="form-control" name="tanggal_pelaksanaan_klemseng" placeholder="Tanggal Pelaksanaan" required>
          </div>
          <div class="col-md-4">
            Keterangan<br>
