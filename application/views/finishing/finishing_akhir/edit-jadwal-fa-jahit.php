      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="card-body">
                ...
                <input class="form-check-input" type="checkbox" name="status_jahit" value="jahit" id="flexCheckDefault" <?php echo $row->status_jahit == "jahit" ?  "checked" : "" ?>>
        ...
        <div class="row">
          <div class="col-md-4">
            ...
            <input type="date" class="form-control" name="tanggal_pelaksanaan_jahit" placeholder="Tanggal Pelaksanaan" value="<?= $row->tanggal_pelaksanaan_jahit; ?>">
          </div>
          <div class="col-md-4">
            Keterangan<br>
