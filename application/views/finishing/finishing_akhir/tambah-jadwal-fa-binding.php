...
<section class="content">
  <div class="card">
    ...
    <form action="<?=site_url('finishing/FinishingAkhir/proses_binding')?>" method="post">  
     ...
     <?php $jadwal_max+=1; ?>
    <input type="text"  name="id_jadwal_binding"  value="<?= $jadwal_max; ?>" hidden>     
      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="card-body">
                ...
                <input type="text" name="status_binding" value="" hidden>
                <input class="form-check-input" type="checkbox" name="status_binding" value="binding" id="flexCheckDefault" <?php echo $row->status_binding == "binding" ?  "checked" : "" ?> disabled>
        ...
        <div class="row">
          <div class="col-md-4">
            ...
            <input type="date" class="form-control" name="tanggal_pelaksanaan_binding" placeholder="Tanggal Pelaksanaan" required>
          </div>
          <div class="col-md-4">
            Keterangan<br>
            <textarea name="keterangan_jadwal_binding" class="form-control" placeholder="catatan" style="height: 150px;"><?= $row->keterangan_jadwal_binding; ?></textarea>
          </div>
          <div class="col-md-4">  
            Hasil Susun<br>
