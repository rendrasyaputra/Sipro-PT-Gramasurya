...
<section class="content">
  <div class="card">
    ...
    <input disabled type="text"  name="id_spiral"  value="<?= $row->id_spiral; ?>" hidden>
      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="card-body">
                ...
                <input disabled type="text" name="status_spiral" value="" hidden>
                <input disabled class="form-check-input" type="checkbox" name="status_spiral" value="spiral" id="flexCheckDefault" <?php echo $row->status_spiral == "spiral" ?  "checked" : "" ?>>
        ...
        <div class="row">
          <div class="col-md-4">
            ...
            <input disabled type="date" class="form-control" name="tanggal_pelaksanaan_spiral" placeholder="Tanggal Pelaksanaan" value="<?= $row->tanggal_pelaksanaan_spiral; ?>">
          </div>
          <div class="col-md-4">
            Keterangan<br>
            <textarea disabled name="keterangan_jadwal_spiral" class="form-control" placeholder="catatan" style="height: 150px;"><?= $row->keterangan_jadwal_spiral; ?></textarea>
          </div>
          <div class="col-md-4">  
            Hasil Gabung<br>
