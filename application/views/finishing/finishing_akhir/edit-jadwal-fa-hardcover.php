      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="card-body">
                ...
                <input class="form-check-input" type="checkbox" name="status_hardcover" value="hardcover" id="flexCheckDefault" <?php echo $row->status_hardcover == "hardcover" ?  "checked" : "" ?>>
        ...
        <div class="row">
          <div class="col-md-4">
            ...
            <input type="date" class="form-control" name="tanggal_pelaksanaan_hardcover" placeholder="Tanggal Pelaksanaan" value="<?= $row->tanggal_pelaksanaan_hardcover; ?>">
          </div>
          <div class="col-md-4">
            Keterangan<br>
