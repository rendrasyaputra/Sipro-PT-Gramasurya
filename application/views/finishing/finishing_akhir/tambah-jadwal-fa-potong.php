...
<section class="content">
  <div class="card">
    ...
    <form action="<?=site_url('finishing/FinishingAkhir/proses_fa_potong')?>" method="post"> 
     ...
     <?php $jadwal_max+=1; ?>
    <input type="text"  name="id_jadwal_fa_potong"  value="<?= $jadwal_max; ?>" hidden>     
      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="card-body">
                ...
                <input type="text" name="status_fa_potong" value="" hidden>
                <input class="form-check-input" type="checkbox" name="status_fa_potong" value="fa potong" id="flexCheckDefault" <?php echo $row->status_fa_potong == "fa potong" ?  "checked" : "" ?> disabled>
        ...
        <div class="row">
          <div class="col-md-4">
            ...
            <input type="date" class="form-control" name="tanggal_pelaksanaan_fa_potong" placeholder="Tanggal Pelaksanaan" required>
          </div>
          <div class="col-md-4">
            Keterangan<br>
            <textarea name="keterangan_jadwal_fa_potong" class="form-control" placeholder="catatan" style="height: 150px;"><?= $row->keterangan_jadwal_fa_potong; ?></textarea>
          </div>
          <div class="col-md-4">  
            Hasil Binding<br>
