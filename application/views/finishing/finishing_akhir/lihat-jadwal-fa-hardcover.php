  ...
  <div class="card">
    <div class="card-header">
      <div class="card-title">
        <h3>Mesin hardcover</h3>
      </div>
    </div>
    <!-- /.card-header -->
    <?php foreach($fa as $s => $row) {?>  
    <form action="<?=site_url('finishing/FinishingAkhir/proses_hardcover')?>" method="post">      
    <input disabled type="text"  name="id_order"  value="<?= $row->id_order; ?>" hidden>
    <input disabled type="text"  name="id_hardcover"  value="<?= $row->id_hardcover; ?>" hidden>
      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="card-body">
                ...
                <input disabled type="text" name="status_hardcover" value="" hidden>
                <input disabled class="form-check-input" type="checkbox" name="status_hardcover" value="hardcover" id="flexCheckDefault" <?php echo $row->status_hardcover == "hardcover" ?  "checked" : "" ?>>
        ...
        <div class="row">
          <div class="col-md-4">
            ...
            <input disabled type="date" class="form-control" name="tanggal_pelaksanaan_hardcover" placeholder="Tanggal Pelaksanaan" value="<?= $row->tanggal_pelaksanaan_hardcover; ?>">
          </div>
          <div class="col-md-4">
            Keterangan<br>
            <textarea disabled name="keterangan_jadwal_hardcover" class="form-control" placeholder="catatan" style="height: 150px;"><?= $row->keterangan_jadwal_hardcover; ?></textarea>
          </div>
          <div class="col-md-4">  
            Hasil Susun<br>
        ...
        <div class="row">
          ...
          <a href="<?=site_url()?>finishing/FinishingAkhir/jadwal_fa_hardcover" class="btn btn-default">Kembali</a>            
          </div>
        </div>
