      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="card-body">
                ...
                <input class="form-check-input" type="checkbox" name="status_spiral" value="spiral" id="flexCheckDefault" <?php echo $row->status_spiral == "spiral" ?  "checked" : "" ?>>
        ...
        <div class="row">
          <div class="col-md-4">
            ...
            <input type="date" class="form-control" name="tanggal_pelaksanaan_spiral" placeholder="Tanggal Pelaksanaan" value="<?= $row->tanggal_pelaksanaan_spiral; ?>">
          </div>
          <div class="col-md-4">
            Keterangan<br>
