<section class="content">
  <div class="row bg-success" align="center" style="padding: 30px;padding-top: 35px;">
    <div class="col"><h3><b>MESIN BINDING</b></h3></div>
  </div>
</section>
<!-- Content Header (Page header) -->
<?php foreach($fa as $s => $row) {?>  
    <form action="<?=site_url('finishing/OperatorFA/proses_binding')?>" method="post"> 
    ...
    <div class="row">
      <div class="col">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">
            <a href="<?=site_url()?>finishing/OperatorFA/jadwal_op_binding" style="color: #FC8639  ;">
              binding
            </a>
          </li>
          <li class="breadcrumb-item">
...
<!-- Main content -->    
    <input type="text" value="<?= $row->status_binding; ?>" name="status_binding" hidden>
    <input type="text"  name="id_order"  value="<?= $row->id_order; ?>" hidden>
    <input type="text"  name="id_binding"  value="<?= $row->id_binding; ?>" hidden>
    ...
    <div class="col" style="background: #FFEEE3;">
      ...
      <div class="row" style="padding-left: 20px;padding-right: 20px;margin-top: -20px;">
        <div class="col-md-12">
          ...
          <input type="date" value="<?= $row->tanggal_pelaksanaan_binding; ?>" name="tanggal_pelaksanaan_binding" hidden>
          <input type="date" class="form-control" name="tanggal_pelaksanaan_binding" value="<?= $row->tanggal_pelaksanaan_binding; ?>" disabled>
        </div>
      </div>
      <div class="row" style="padding-left: 20px;padding-right: 20px;padding-top: 15px;padding-bottom: 15px;">
        <div class="col-md-12">
          <label>Keterangan</label>
          <input type="text" value="<?= $row->keterangan_jadwal_binding; ?>" name="keterangan_jadwal_binding" hidden>
          <textarea disabled class="form-control" name="keterangan_jadwal_binding" style="height: 100px;" placeholder="Keterangan"><?= $row->keterangan_jadwal_binding; ?></textarea>
        </div>
        <div class="col-md-12">
