<section class="content">
  <div class="row bg-success" align="center" style="padding: 30px;padding-top: 35px;">
    <div class="col"><h3><b>MESIN HARDCOVER</b></h3></div>
  </div>
</section>
...
<section class="content">
  ...
  <div class="row" style="padding: 10px;">
    <div class="col" style="background: #FFEEE3;">
      ...
      <div class="row" style="padding: 10px;">
        <div class="col">
          <a href="<?=site_url()?>finishing/OperatorFA/edit_op_hardcover/<?= $row->id_hardcover; ?>" class="btn btn-success" style="min-height: 50px;width: 100%;padding-top: 12px;">
