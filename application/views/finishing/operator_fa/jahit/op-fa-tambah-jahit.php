...
<?php foreach($fa as $s => $row) {?>  
    <form action="<?=site_url('finishing/OperatorFA/proses_jahit')?>" method="post"> 
    ...
    <div class="row">
      <div class="col">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">
            <a href="<?=site_url()?>finishing/OperatorFA/jadwal_op_jahit" style="color: #FC8639  ;">
              jahit
            </a>
          </li>
          <li class="breadcrumb-item">
...
<!-- Main content -->    
    <input type="text" value="<?= $row->status_jahit; ?>" name="status_jahit" hidden>
    ...
    <div class="col" style="background: #FFEEE3;">
      ...
      <div class="row" style="padding-left: 20px;padding-right: 20px;margin-top: -20px;">
        <div class="col-md-12">
          ...
          <input type="date" value="<?= $row->tanggal_pelaksanaan_jahit; ?>" name="tanggal_pelaksanaan_jahit" hidden>
          <input type="date" class="form-control" name="tanggal_pelaksanaan_jahit" value="<?= $row->tanggal_pelaksanaan_jahit; ?>" disabled>
        </div>
      </div>
      <div class="row" style="padding-left: 20px;padding-right: 20px;padding-top: 15px;padding-bottom: 15px;">
        <div class="col-md-12">
          <label>Keterangan</label>
          <input type="text" value="<?= $row->keterangan_jadwal_jahit; ?>" name="keterangan_jadwal_jahit" hidden>
          <textarea disabled class="form-control" name="keterangan_jadwal_jahit" style="height: 100px;" placeholder="Keterangan"><?= $row->keterangan_jadwal_jahit; ?></textarea>
        </div>
        <div class="col-md-12">
