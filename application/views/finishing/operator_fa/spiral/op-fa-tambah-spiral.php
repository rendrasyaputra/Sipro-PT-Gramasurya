<section class="content">
  <div class="row bg-success" align="center" style="padding: 30px;padding-top: 35px;">
    <div class="col"><h3><b>MESIN SPIRAL</b></h3></div>
  </div>
</section>
<!-- Content Header (Page header) -->
<?php foreach($fa as $s => $row) {?>  
    <form action="<?=site_url('finishing/OperatorFA/proses_spiral')?>" method="post"> 
    ...
    <div class="row">
      <div class="col">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">
            <a href="<?=site_url()?>finishing/OperatorFA/jadwal_op_spiral" style="color: #FC8639  ;">
              spiral
            </a>
          </li>
          <li class="breadcrumb-item">
...
<!-- Main content -->    
    <input type="text" value="<?= $row->status_spiral; ?>" name="status_spiral" hidden>
    ...
    <div class="col" style="background: #FFEEE3;">
      ...
      <div class="row" style="padding-left: 20px;padding-right: 20px;margin-top: -20px;">
        <div class="col-md-12">
          ...
          <input type="date" value="<?= $row->tanggal_pelaksanaan_spiral; ?>" name="tanggal_pelaksanaan_spiral" hidden>
          <input type="date" class="form-control" name="tanggal_pelaksanaan_spiral" value="<?= $row->tanggal_pelaksanaan_spiral; ?>" disabled>
        </div>
      </div>
      <div class="row" style="padding-left: 20px;padding-right: 20px;padding-top: 15px;padding-bottom: 15px;">
        <div class="col-md-12">
          <label>Keterangan</label>
          <input type="text" value="<?= $row->keterangan_jadwal_spiral; ?>" name="keterangan_jadwal_spiral" hidden>
          <textarea disabled class="form-control" name="keterangan_jadwal_spiral" style="height: 100px;" placeholder="Keterangan"><?= $row->keterangan_jadwal_spiral; ?></textarea>
        </div>
        <div class="col-md-12">
