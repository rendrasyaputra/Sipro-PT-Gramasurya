    ...
    <div class="card-body">
      <div class="card-body">
        ...
        <div class="row">
          ...
          <input class="form-check-input" type="checkbox" name="status_shoe" value="shoe" id="flexCheckDefault" <?php echo $row->status_shoe == "shoe" ?  "checked" : "" ?>>
        ...
        <div class="col-md-4">
            ...
            <input <?php echo $row->status_shoe == "shoe" ?  "disabled" : ""?> type="date" class="form-control" name="tanggal_pelaksanaan_shoe" placeholder="Tanggal Pelaksanaan" value="<?= $row->tanggal_pelaksanaan_shoe; ?>" required>
          </div>
          <div class="col-md-4">
            Jenis shoe<br>
            <label>
