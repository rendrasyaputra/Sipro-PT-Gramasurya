  ...
  <div class="card">
    <div class="card-header">
      <div class="card-title">
        <h3>Lihat Penjadwalan Mesin sub</h3>
      </div>
    </div>
    <!-- /.card-header -->
      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-4">
            ...
            <input <?php echo $row->status_sub == "sub" ?  "disabled" : "disabled"?> type="date" class="form-control" name="tanggal_pelaksanaan_sub" placeholder="Tanggal Pelaksanaan" value="<?= $row->tanggal_pelaksanaan_sub; ?>" required>
          </div>
          ...
          <div class="col-md-4">
            ...
            <textarea  <?php echo $row->status_sub == "sub" ?  "disabled" : "disabled"?> name="keterangan_jadwal_sub" class="form-control" placeholder="catatan" style="height: 100px;"><?= $row->keterangan_jadwal_sub; ?></textarea>
          </div>  
          ...
          <div class="col-md-3">
            ...
            <div class="form-check">
                ...
                <input disabled class="form-check-input" type="checkbox" name="jenis_sub_lipat" value="lipat" id="flexCheckDefault" <?php echo $row->jenis_sub_lipat == "lipat" ?  "checked" : "" ?>>
                <label class="form-check-label" for="flexCheckDefault">lipat</label><br>

                <input type="text" name="jenis_sub_susun_gabung" value="" hidden>
                <input disabled class="form-check-input" type="checkbox" name="jenis_sub_susun_gabung" value="susun gabung" id="flexCheckDefault" <?php echo $row->jenis_sub_susun_gabung == "susun gabung" ?  "checked" : "" ?>>
                ...
                <input disabled class="form-check-input" type="checkbox" name="jenis_sub_laminasi" value="laminasi" id="flexCheckDefault" <?php echo $row->jenis_sub_laminasi == "laminasi" ?  "checked" : "" ?>>
        ...
        <div class="row">
          <div class="col-md-1" align="center"><label <?php echo $row->status_sub == "sub" ?  "disabled" : "disabled"?>>1</label></div>
          <div class="col-md-2">
            <input <?php echo $row->status_sub == "sub" ?  "disabled" : "disabled"?>  type="date" class="form-control" name="tanggal_kembali_1" placeholder="Tanggal Kembali" value="<?= $row->tanggal_kembali_1; ?>">
          </div>
          <div class="col-md-1">
            <input <?php echo $row->status_sub == "sub" ?  "disabled" : "disabled"?>  type="number" class="form-control" name="hasil_1" placeholder="Hasil" value="<?= $row->hasil_1; ?>">
          </div>          
          <div class="col-md-2">
            <input <?php echo $row->status_sub == "sub" ?  "disabled" : "disabled"?>  type="number" class="form-control" name="rejek_1" placeholder="rejek" value="<?= $row->rejek_1; ?>">
          </div>          
          <div class="col-md-3">
            <input <?php echo $row->status_sub == "sub" ?  "disabled" : "disabled"?>  type="text" class="form-control" name="keterangan_1" placeholder="Keterangan" value="<?= $row->keterangan_1; ?>">
          </div>
        </div><br>
        <div class="row">
          <div class="col-md-1" align="center"><label <?php echo $row->status_sub == "sub" ?  "disabled" : "disabled"?>>2</label></div>
          <div class="col-md-2">
            <input <?php echo $row->status_sub == "sub" ?  "disabled" : "disabled"?>  type="date" class="form-control" name="tanggal_kembali_2" placeholder="Tanggal Kembali" value="<?= $row->tanggal_kembali_2; ?>">
          </div>
          <div class="col-md-1">
            <input <?php echo $row->status_sub == "sub" ?  "disabled" : "disabled"?>  type="number" class="form-control" name="hasil_2" placeholder="Hasil" value="<?= $row->hasil_2; ?>">
          </div>          
          <div class="col-md-2">
            <input <?php echo $row->status_sub == "sub" ?  "disabled" : "disabled"?>  type="number" class="form-control" name="rejek_2" placeholder="rejek" value="<?= $row->rejek_2; ?>">
          </div>          
          <div class="col-md-3">
            <input <?php echo $row->status_sub == "sub" ?  "disabled" : "disabled"?>  type="text" class="form-control" name="keterangan_2" placeholder="Keterangan" value="<?= $row->keterangan_2; ?>">
          </div>
